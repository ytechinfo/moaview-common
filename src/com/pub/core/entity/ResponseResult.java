  ...
  implements Serializable
{
  ...
  {
    return "ResponseResult  [status=" + this.status + ", resultCode=" + this.resultCode + ", message=" + this.messageCode + ", items=" + this.list + 
      ", item=" + this.item + ", page=" + this.page + "]";
  }
}